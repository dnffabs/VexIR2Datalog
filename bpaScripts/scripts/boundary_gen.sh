...
CONVERT_OFFSET_SCRIPT="$UTILS_DIR/convert_offset.py"

RULES_DIR="./rules"

PREPROCESS_DL="$RULES_DIR/preprocess.dl"
BOUNDARY_GEN_DL="$RULES_DIR/boundary_gen.dl"
LOCAL_BLOCK_BOUNDARY_DL="$RULES_DIR/local_block_boundary.dl"
...
#开始生成局部的alocs
souffle -F "$FACTS_DIR" -D "$FACTS_DIR" "$LOCAL_BLOCK_BOUNDARY_DL"
